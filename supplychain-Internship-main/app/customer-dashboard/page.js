            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
              ...
              {!scannedData ? (
                <button
                  ...
                  className="bg-green-600 hover:bg-green-700 text-white rounded-full px-8 py-3 font-medium whitespace-nowrap"
                >
                ...
                <button
                  onClick={resetScan}
                  className="bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-full px-8 py-3 font-medium whitespace-nowrap"
                >
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 flex flex-col items-center justify-center bg-gray-50 min-h-64">
                {isLoading ? (
                  ...
                  <>
                    ...
                    <button
                      onClick={handleScan}
                      className="bg-green-600 hover:bg-green-700 text-white rounded-full px-6 py-2 text-sm font-medium"
                    >
                      Simulate Scan
                    </button>
